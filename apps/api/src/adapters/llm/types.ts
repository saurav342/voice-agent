...
export interface RealtimeProvider {
  ...
  /** User spoken text transcribed by the provider (realtime). Optional. */
  onUserTranscript?(handler: (text: string, finished: boolean) => void): void;
  ...
  /** Update the system prompt dynamically (e.g. after variable interpolation). */
