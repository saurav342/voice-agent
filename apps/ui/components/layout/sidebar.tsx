...
export function Sidebar({ isSuperadmin, isActingTenant, balance, className }: Props) {
  ...
  return (
    ...
    >
      ...
      {/* ── Sign Out Button ── */}
      <div className="p-3.5 border-t border-[var(--c-border)] mt-auto">
        <button
          type="button"
          onClick={async () => {
          ...
          className="w-full flex items-center gap-3.5 px-3.5 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 text-rose-500 hover:text-rose-600 hover:bg-rose-500/10 cursor-pointer select-none"
        >
